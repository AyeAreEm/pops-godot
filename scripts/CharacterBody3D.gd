...
const MAX_VELOCITY_GROUND = 4.0
const MAX_ACCELERATION = 9 * MAX_VELOCITY_GROUND
const GRAVITY = 15.34
const STOP_SPEED = 3
const JUMP_IMPULSE = sqrt(2 * GRAVITY * 0.70)
...
func _physics_process(delta):
	TestGlobalVar.pos = global_transform.origin
